//! Quests tab — placeholder shell (SPEC §17).
//!
//! Quest rows, grouping and the detail panel (SPEC §17) lands in **bd-8lz.4.2**. The seams below are what that bead fills in:
...
pub fn render(frame: &mut Frame, area: Rect, app: &App) {
    super::placeholder(frame, area, "Quests", "bd-8lz.4.2", app);
}
