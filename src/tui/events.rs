//! Events tab — placeholder shell (SPEC §17).
//!
//! Live event tail, filtered by Quest and kind (SPEC §17) lands in **bd-8lz.4.6**. The seams below are what that bead fills in:
...
pub fn render(frame: &mut Frame, area: Rect, app: &App) {
    super::placeholder(frame, area, "Events", "bd-8lz.4.6", app);
}
