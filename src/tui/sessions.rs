//! Sessions tab — placeholder shell (SPEC §17).
//!
//! The fleet view across every Quest (SPEC §17) lands in **bd-8lz.4.5**. The seams below are what that bead fills in:
...
pub fn render(frame: &mut Frame, area: Rect, app: &App) {
    super::placeholder(frame, area, "Sessions", "bd-8lz.4.5", app);
}
